...
```{r, echo = FALSE}
DT::datatable(tax.clean, options = list(autowidth = TRUE, scrollX=T))
```
...
If you want a GUI software for your microbiome analysis, you may like [microbiomeanalyst](https://www.microbiomeanalyst.ca/), which was recently published on [Nature protocol](https://www.nature.com/articles/s41596-019-0264-1). `r emo::ji("munch")`